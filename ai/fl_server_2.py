...
from fl_client_2 import TARGET_COLUMNS, get_input_dim, get_params, make_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Flower server for next-hour mixed-loss MLP training.")
    ...
    parser.add_argument("--weights-out-dir", default="ai/fl_weights_sim_2", help="Directory to write global weights and metrics")
...
class TrackingFedAvg2(fl.server.strategy.FedAvg):
