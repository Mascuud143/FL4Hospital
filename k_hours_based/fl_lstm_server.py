...
try:
    from k_hours_based.fl_lstm_client import TARGET_COLUMNS, get_input_dim, get_params, make_model
except ModuleNotFoundError:
    from fl_lstm_client import TARGET_COLUMNS, get_input_dim, get_params, make_model
...
class TrackingFedAvg(fl.server.strategy.FedAvg):
    ...
    def aggregate_evaluate(self, server_round, results, failures):
        ...
        self.latest_eval_summary = {
            ...
            "threshold_correct_y_temp_main": int(summary["threshold_correct_y_temp_main"]),
            "threshold_wrong_y_temp_main": int(summary["threshold_wrong_y_temp_main"]),
            "threshold_correct_y_temp_toilet": int(summary["threshold_correct_y_temp_toilet"]),
            "threshold_wrong_y_temp_toilet": int(summary["threshold_wrong_y_temp_toilet"]),
            "threshold_correct_y_light": int(summary["threshold_correct_y_light"]),
            "threshold_wrong_y_light": int(summary["threshold_wrong_y_light"]),
            "threshold_correct_y_sound": int(summary["threshold_correct_y_sound"]),
            "threshold_wrong_y_sound": int(summary["threshold_wrong_y_sound"]),
